        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-3 sm:p-4 lg:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-600 text-xs sm:text-sm font-medium">Total Accountants</p>
                <p className="text-sm sm:text-base font-bold text-slate-800">{stats.total}</p>
              </div>
              <div className="bg-blue-100 p-2 sm:p-3 rounded-lg">
                <Calculator className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600" />
              </div>
            </div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-green-100 p-3 sm:p-4 lg:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-600 text-xs sm:text-sm font-medium">Active Accountants</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-red-100 p-3 sm:p-4 lg:p-6 col-span-2 sm:col-span-1">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-600 text-xs sm:text-sm font-medium">Inactive Accountants</p>
          ...
          <div className="block md:hidden">
            {loading ? (
              <div className="p-6 sm:p-8 text-center">
                ...
                <p className="text-slate-600 font-medium text-xs sm:text-sm">Loading accountants...</p>
              ...
              <div className="p-6 sm:p-8 text-center">
                <div className="bg-slate-100 w-20 h-20 sm:w-24 sm:h-24 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Calculator className="h-10 w-10 sm:h-12 sm:w-12 text-slate-400" />
                </div>
                <h3 className="text-sm sm:text-base font-semibold text-slate-700 mb-2">No Accountants Found</h3>
                <p className="text-slate-500 mb-4 sm:mb-6 text-xs sm:text-sm">Get started by adding your first accountant.</p>
                <button
                  onClick={() => navigate('/dashboard/centeradmin/accountant/addaccountant')}
              ...
              <div className="p-3 sm:p-4 space-y-3 sm:space-y-4">
                {accountants.map((accountant) => (
                  <div key={accountant._id} className="bg-slate-50 rounded-lg p-3 sm:p-4 space-y-3 border border-slate-200">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h3 className="font-medium text-slate-800 text-xs sm:text-sm">{accountant.name || 'Unknown'}</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                      <div className="flex items-center gap-2 bg-white p-2 rounded-lg border border-slate-200">
                        ...
                        <span className="text-slate-700 text-xs font-medium truncate">{accountant.email}</span>
                      </div>
                      <div className="flex items-center gap-2 bg-white p-2 rounded-lg border border-slate-200">
                    ...
                    <div className="flex gap-1 sm:gap-2 pt-2 sm:pt-3 border-t border-slate-200">
                      ...
                      >
                        {accountant.status === 'active' ? <UserX className="h-3 w-3 sm:h-4 sm:w-4" /> : <UserCheck className="h-3 w-3 sm:h-4 sm:w-4" />}
                        <span className="hidden sm:inline">{accountant.status === 'active' ? 'Deactivate' : 'Activate'}</span>
                      </button>
                      <button
                        onClick={() => {
