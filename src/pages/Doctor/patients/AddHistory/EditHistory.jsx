...
export default function EditHistory() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/dashboard/doctor/patients/viewhistory/${patientId}`);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-4 sm:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <button
            onClick={() => navigate(`/dashboard/doctor/patients/viewhistory/${patientId}`)}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Hay Fever</label>
                  <input
                    type="text"
                    name="hayFever"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Hay Fever Duration (months)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Asthma</label>
                  <input
                    type="text"
                    name="asthma"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Asthma Duration (months)</label>
                  <input
                    type="number"
                    name="asthmaDuration"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Breathing Problems</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Breathing Problems Duration (months)</label>
                  <input
                    type="number"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Fever Grade</label>
                  <input
                    type="text"
                    name="feverGrade"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Itching/Sore Throat</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Specific Day Exposure</label>
                  <input
                    type="text"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Exacerbations Frequency</label>
                  <input
                    type="text"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="flex items-center">
                  ...
                  />
                  <label className="ml-2 text-sm text-slate-700">URTIs</label>
                </div>
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-2 text-sm text-slate-700">Cold Weather</label>
                </div>
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-2 text-sm text-slate-700">Pollen</label>
                </div>
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-2 text-sm text-slate-700">Smoke</label>
                </div>
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-2 text-sm text-slate-700">Exercise</label>
                </div>
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-2 text-sm text-slate-700">Pets</label>
                </div>
              </div>
              <div className="mt-4">
                <label className="block text-sm font-medium text-slate-700 mb-2">Other Triggers</label>
                <input
                  type="text"
                  name="triggersOthers"
