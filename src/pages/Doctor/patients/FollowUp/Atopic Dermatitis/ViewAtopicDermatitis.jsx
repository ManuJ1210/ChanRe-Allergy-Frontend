        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4 text-xs">No atopic dermatitis record found for this patient.</p>
              <button
                onClick={() => navigate(-1)}
                className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-xs"
              >
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-md font-bold text-gray-800">Atopic Dermatitis Record</h1>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          ...
          <div className="bg-blue-50 rounded-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium text-xs">{latestRecord.patientId?.gender || 'N/A'}</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <div className="bg-gray-50 rounded-md p-3 border">
                  <p className="text-gray-900 text-xs">{latestRecord.symptoms || 'No symptoms recorded'}</p>
                </div>
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-2">Affected Areas/Surface of the body</label>
                <div className="bg-gray-50 rounded-md p-3 border">
                  <p className="text-gray-900 text-xs">{latestRecord.affectedAreas || 'No affected areas recorded'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 rounded-md p-3 border">
                  <span className="text-gray-900 text-xs">{latestRecord.drynessWithoutEczema || 'Not specified'}</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={key}>
                  ...
                  <div className="bg-gray-50 rounded-md p-3 border">
                    <span className="text-gray-900 text-xs">{latestRecord[key] || 'Not specified'}</span>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="bg-gray-50 rounded-md p-3 border">
                  <span className="text-gray-900 text-xs">Value: {latestRecord.itching || 0}</span>
                </div>
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-3">Severity of Sleep Disturbance</label>
                <div className="bg-gray-50 rounded-md p-3 border">
                  <span className="text-gray-900 text-xs">Value: {latestRecord.sleepDisturbance || 0}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Medications Section */}
          <div className="space-y-6">
            <h2 className="text-sm font-semibold text-gray-800 border-b border-gray-200 pb-2">Medications</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-2">Present Medications</label>
                <div className="bg-gray-50 rounded-md p-3 border">
                  <p className="text-gray-900 text-xs">{latestRecord.presentMedications || 'No medications recorded'}</p>
                </div>
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-2">Local Applications</label>
                <div className="bg-gray-50 rounded-md p-3 border">
                  <p className="text-gray-900 text-xs">{latestRecord.localApplications || 'No local applications recorded'}</p>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="bg-gray-50 rounded-md p-3 border">
                <p className="text-gray-900 text-xs">{latestRecord.otherMedications || 'No other medications recorded'}</p>
              </div>
            </div>
          </div>
