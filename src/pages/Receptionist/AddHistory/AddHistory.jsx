...
import { createReceptionistPatientHistory, fetchReceptionistPatientHistory } from "../../../features/receptionist/receptionistThunks";
...
export default function AddHistory() {
  ...
  const { loading, error, addHistorySuccess, history, historyLoading, historyError } = useSelector((state) => state.receptionist);
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(createReceptionistPatientHistory(historyDataWithPatientId));
  };
