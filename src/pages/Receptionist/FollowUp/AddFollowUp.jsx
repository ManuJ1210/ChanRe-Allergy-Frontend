...
import { addReceptionistFollowUp, resetReceptionistState } from '../../../features/receptionist/receptionistThunks';
import { 
  ArrowLeft, 
  Calendar, 
  User, 
...
const AddFollowUp = () => {
  ...
  const { loading, error, addFollowUpSuccess } = useSelector(state => state.receptionist);
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(addReceptionistFollowUp(payload));
  };
