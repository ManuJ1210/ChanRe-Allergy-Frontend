...
import { Eye, ArrowLeft, Calendar, User, AlertCircle } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800 mb-2">
            Allergic Conjunctivitis Records
          </h1>
          <p className="text-slate-600">
            View and manage allergic conjunctivitis assessment records
          </p>
        </div>
            ...
            {loading ? (
              ...
              <div className="p-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-500">No allergic conjunctivitis assessment records available for this patient.</p>
                </div>
              </div>
            ) : (
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-center">
                          <button
                            ...
                            onClick={() => navigate(`/dashboard/Superadmin/Followups/ViewAllergicConjunctivitis/${patientId}`)}
                          >
