...
export default function SuperadminAllergicRhinitisList() {
  ...
  useEffect(() => {
    const fetchRecords = async () => {
      ...
      try {
        ...
        const res = await API.get(`/allergic-rhinitis?patientId=${patientId}`, { headers: { Authorization: `Bearer ${token}` } });
        setRecords(res.data);
      } catch (err) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800 mb-2">
            Allergic Rhinitis Records
          </h1>
          <p className="text-slate-600">
            View and manage allergic rhinitis assessment records
          </p>
        </div>
            ...
            {loading ? (
              ...
              <div className="p-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-500">No allergic rhinitis assessment records available for this patient.</p>
                </div>
              </div>
            ) : (
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-center">
                          <button
                            ...
                            onClick={() => navigate(`/dashboard/Superadmin/Followups/ViewAllergicRhinitis/${patientId}`)}
                          >
