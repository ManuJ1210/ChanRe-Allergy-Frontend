...
export default function GPEList() {
  ...
  useEffect(() => {
    const fetchRecords = async () => {
      ...
      try {
        ...
        const res = await API.get(`/gpe?patientId=${patientId}`, { headers: { Authorization: `Bearer ${token}` } });
        setRecords(res.data);
      } catch (err) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            View and manage GPE (General Physical Examination) assessment records
          </p>
        </div>
            ...
            {loading ? (
              ...
              <div className="p-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-500">No GPE assessment records available for this patient.</p>
                </div>
              </div>
            ) : (
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-center">
                          <button
                            ...
                            onClick={() => navigate(`/dashboard/Superadmin/Followups/ViewGPE/${patientId}`)}
                          >
